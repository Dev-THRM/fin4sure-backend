...
import { getBrokerLeads, getReferredClients, referClient } from "../controllers/broker.controller.js";
...
brokerRouter.post("/referClient", verifyUser, isBroker, referClient);
